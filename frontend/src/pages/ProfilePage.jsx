...
const ProfilePage = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    city: 'New York',
    travelPreference: 'Luxury & Adventure',
    bio: 'Passionate traveler exploring the world one city at a time. Love discovering hidden gems and experiencing local cultures.',
  ...
  // Statistics data
  const statistics = [
    { icon: Plane, label: 'Total Trips', value: '12', color: 'indigo', gradient: 'from-indigo-600 to-indigo-400' },
    { icon: CalendarIcon, label: 'Upcoming Trips', value: '3', color: 'pink', gradient: 'from-pink-600 to-pink-400' },
    { icon: CheckCircle, label: 'Completed Trips', value: '9', color: 'green', gradient: 'from-green-600 to-green-400' },
    { icon: Globe, label: 'Countries Visited', value: '15', color: 'purple', gradient: 'from-purple-600 to-purple-400' },
    { icon: DollarSign, label: 'Total Spent', value: '$24,500', color: 'amber', gradient: 'from-amber-600 to-amber-400' },
  ]
  ...
  const previousTrips = [
    ...
    },
    {
      ...
      cities: 'Reykjavik, Golden Circle',
      duration: '8 days',
      budget: '$2,800',
      rating: 5,
      image: 'https://images.unsplash.com/photo-1435234425256-d53c6d923586?w=600&h=400&fit=crop',
      year: '2023'
    },
    {
      id: 6,
      title: 'South American Journey',
      cities: 'Rio, Buenos Aires, Lima',
      duration: '18 days',
      budget: '$4,100',
      rating: 4,
          ...
          {plannedTrips.map((trip, idx) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-gray-400 mb-2">{trip.cities}</p>
                ...
                <div className="mb-3">
                  ...
                  <div className="h-2 bg-[rgba(255,255,255,0.1)] rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-indigo-500 to-pink-500 rounded-full" style={{ width: `${trip.progress}%` }} />
                  </div>
                </div>
            ...
            {previousTrips.map((trip, idx) => (
              ...
              >
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="sm:w-32 h-24 rounded-xl overflow-hidden">
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">{trip.cities}</p>
                      </div>
